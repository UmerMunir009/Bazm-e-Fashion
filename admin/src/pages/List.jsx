  ...
  return (
    ...
    <>
      ...
      <div className='px-5 sm:px-10 py-0 flex flex-col gap-2  '>
        ...
        <div className=' grid grid-cols-[1fr_1fr_1fr_1fr_1fr] sm:grid-cols-[1fr_3fr_1fr_1fr_1fr] p-2 text-[7px] md:text-[11px] bg-gray-200'>
          <b>Image</b><b>Name</b><b>Category</b><b>Sub Category</b><b className='text-center'>Action</b>
        </div>
        {
          products.map((item, index) => (

            <div className='grid  rounded grid-cols-[1fr_1fr_1fr_1fr_1fr] sm:grid-cols-[1fr_3fr_1fr_1fr_1fr] bg-pink-100 p-2 items-center   ' key={index}>
