    ...
    <div>
      ...
      <div className='flex flex-col md:flex-row gap-7 justify-center'>
        ...
        <div className='flex flex-col gap-6 justify-center items-start'>
          ...
          <button onClick={()=>navigate('/placeOrders')} className='bg-white cursor-pointer text-black border border-gray-500 text-xs  py-3 px-2 mt-4 rounded hover:bg-black hover:text-white active:bg-white active:text-black min-w-40'>SHOP NOW</button>
